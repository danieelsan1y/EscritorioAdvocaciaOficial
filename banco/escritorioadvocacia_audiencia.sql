...
CREATE TABLE `audiencia` (
  ...
  `nroAudiencia` varchar(100) NOT NULL,
  `dataAudi` date DEFAULT NULL,
  `parecer` varchar(500) DEFAULT NULL,
  `idProcesso` int DEFAULT NULL,
  PRIMARY KEY (`idAudi`),
  KEY `processoId_idx` (`idProcesso`),
  CONSTRAINT `processoId` FOREIGN KEY (`idProcesso`) REFERENCES `processo` (`idProcesso`)
...
INSERT INTO `audiencia` VALUES (2,'1','2022-02-16','Divisão',1),(3,'2','2022-05-22','divisao',1),(4,'3','2022-03-07','Conciliação',1);
...
-- Dump completed on 2022-03-16 19:31:15
